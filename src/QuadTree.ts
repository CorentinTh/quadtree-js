...
import { QuadTreeConfig, QuadTreeConfigComplete, Shape } from './types';
...
export class QuadTree {
  ...
  private insertRecursive(point: Point): boolean {
    ...
    if (this.isDivided) {
      return this.ne.insertRecursive(point) || this.nw.insertRecursive(point) || this.se.insertRecursive(point) || this.sw.insertRecursive(point);
    } else {
      return false;
    }
  }
